...
namespace SIMS_Project.Migrations
{
    ...
    [Migration("20241227000024_UpdateRelationships")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIMS_Project.Models.Attendance", b =>
                {
            ...
            modelBuilder.Entity("SIMS_Project.Models.Exam", b =>
                {
            ...
            modelBuilder.Entity("SIMS_Project.Models.Fee", b =>
                {
            ...
            modelBuilder.Entity("SIMS_Project.Models.Grade", b =>
                {
            ...
            modelBuilder.Entity("SIMS_Project.Models.Guardian", b =>
                {
            ...
            modelBuilder.Entity("SIMS_Project.Models.Teacher", b =>
                {
                    b.Property<int>("TeacherID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SIMS_Project.Models.User", b =>
                {
                    b.Property<int>("UserID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SIMS_Project.Models.UserRole", b =>
                {
                    b.Property<int>("RoleID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SIMS_Project.Models.Assignment", b =>
                {
                    ...
                    b.HasOne("SIMS_Project.Models.Teacher", "Teacher")
                        .WithMany("Assignments")
            ...
            modelBuilder.Entity("SIMS_Project.Models.Grade", b =>
                {
                    ...
                    b.HasOne("SIMS_Project.Models.Exam", "Exam")
                        .WithMany("Grades")
            ...
            modelBuilder.Entity("SIMS_Project.Models.Guardian", b =>
                {
                    b.HasOne("SIMS_Project.Models.User", "User")
                        .WithOne("Guardian")
                        .HasForeignKey("SIMS_Project.Models.Guardian", "UserID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SIMS_Project.Models.Student", b =>
                {
                    ...
                    b.HasOne("SIMS_Project.Models.Guardian", "Guardian")
                        .WithMany("Students")
            ...
            modelBuilder.Entity("SIMS_Project.Models.Teacher", b =>
                {
                    b.HasOne("SIMS_Project.Models.User", "User")
                        .WithOne("Teacher")
                        .HasForeignKey("SIMS_Project.Models.Teacher", "UserID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SIMS_Project.Models.User", b =>
                {
                    b.HasOne("SIMS_Project.Models.UserRole", "UserRole")
                        .WithMany("Users")
